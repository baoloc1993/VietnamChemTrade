...
public class CatalogueController extends HttpServlet implements Constant{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		// TODO Auto-generated method stub
		req.getRequestDispatcher("jsp/product/catalogue.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			addToDB(fName, email, country, designation, lName, industry, website, ipAddress);
			sendEmail(email, fName + " " + lName, ipAddress);
	 ...
	 * @throws SQLException
	 */
	public void addToDB(String fName, String email, String country, String designation, String lName, String industry, String website, String ipAddress) throws SQLException{
		Connection conn = ConnectionManager.getConnection();
		String sql = "INSERT INTO `tbl_catalogue` (`first_name`, `last_name`, `designation`, `country`, `industry`, `website`, `email`, `ip_address`) VALUES ('"+ fName + "', '" + lName + "', '" + designation + "', '"+ country + "', '" + industry + "', '" + website + "', '" + email + "', '" + ipAddress + "')";
	...
	"                                                                                                            <p style=\"margin-bottom: 1em; text-align: left;\">Cảm ơn bạn đã quan tâm tới chúng tôi. Bạn có thể tải Catalogue thông qua link dưới đây.</p>\n" +
	"                                                                                                            <p style=\"margin-bottom: 1em; \"><a href=\"" + ROOT +"images/catalogue/ProductCatalogue.pdf\"><img src=\"http://cdn2.hubspot.net/hub/492768/hubfs/CoverPage.jpg?t1434423261005&amp;width=186\" alt=\"CoverPage\" width=\"186\" style=\"max-width: 186px; max-height: 807px; width: 186px; float: right;\" align=\"right\" /></a></p>\n" +
	"                                                                                                            <p style=\"margin-bottom: 1em; text-align: justify;\"><a href=\"" + ROOT + "images/catalogue/ProductCatalogue.pdf\">Tải Catalogue miễn phí</a></p>\n" +
	...
	"</table>";
			...
			emailController.sendEmailViaGmail(email, mailF, "Thank you for downloading our Catalogue");
