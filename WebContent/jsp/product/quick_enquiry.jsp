...
<div class="col-xs-12 col-md-6" style= "background-color: #800000; padding-bottom:1%;">
	<div id="contform" class="form-pdd"  >
         ...
         <div class="row" >
             ...
             <div class="col-md-6" style="margin-bottom:5px">
                 <input type="number" placeholder="Contact" id = "contact" name="contact" class="form-control" required>
             </div>
         </div>
         ...
         <div class="row" >
             ...
             <div class="col-md-12" style="margin-bottom:5px">
                 <textarea id = "comments" name="comments" rows="5" class="form-control" placeholder="Comments" required></textarea>
             </div>
