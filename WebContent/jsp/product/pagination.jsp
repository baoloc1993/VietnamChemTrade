...
<%
    ...
    con = DriverManager.getConnection("jdbc:mysql://localhost/prodchem_chemtradeasiacom?zeroDateTimeBehavior=convertToNull", "root", "");
...
// Number of pages index displayed 
    ...
    String sqlPgintn = "SELECT SQL_CALC_FOUND_ROWS * FROM tbl_product limit " + iPagNo + "," + iSwRws + "";
...
<html> <head> <title>Pagination using JSP page</title> </head> 
    ...
    <body> <form name="frm"> 
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" > 
                <tr> <td>Emp Name</td> <td>Emp Batch</td> 
                    <td>Emp Address</td> </tr> 
                    <% while (rsPgin.next()) {%> 
                <tr> <td><%=rsPgin.getString("product_name")%></td> 
                    <td><%=rsPgin.getString("product_name")%></td> 
                    <td><%=rsPgin.getString("product_name")%></td> 
                </tr> 
                <% } %>
...
// Create index of pages 
                            ...
                            <% }
                                ...
                                for (i = ((cPge * iTotSrhRcrds) - (iTotSrhRcrds - 1));
                                        i
                                        <= (cPge
                                        * iTotSrhRcrds); i++) {
                            ...
                            <a href="pagination.jsp?iPagNo=<%=i%>&cPagNo=<%=i%>">>> Next</a> <% }
                                }%> <b>Rows <%=iStRsNo%> - <%=iEnRsNo%> Total Result <%=iTotRslts%></b> </div> </td> </tr> </table> 
        </form> 
    </body> 
</html> 
